        ...
        {imageList.map((img, index) => {
          return (
            <Link
              ...
              className="relative min-w-[12rem] lg:min-w-[14rem] max-w-[12rem] lg:max-w-[14rem] aspect-[9/16] border border-[var(--textColor10)] rounded-[var(--defaultRadius)] overflow-hidden drop_in"
              href={{
                pathname: pathname,
                query: { id: searchParams.get("id"), imgSrc: img.url,description:img.description },
              }}
              scroll={false}
            >
              <Image
